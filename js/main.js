const TRANSLATIONS = {
  RU: {
    ...
    portfolio_project1_title: "Black Blade Barbershop", portfolio_project1_desc: "Премиум барбершоп в Алматы", portfolio_project1_link: "Посмотреть сайт →",
    ...
    contact_telegram: "Написать в Telegram", contact_whatsapp: "Написать в WhatsApp",
  ...
  KZ: {
    ...
    portfolio_project1_title: "Black Blade Barbershop", portfolio_project1_desc: "Алматыдағы премиум шаштараз", portfolio_project1_link: "Сайтты көру →",
    ...
    contact_telegram: "Telegram-ға жазу", contact_whatsapp: "WhatsApp-қа жазу",
  ...
  EN: {
    ...
    portfolio_project1_title: "Black Blade Barbershop", portfolio_project1_desc: "Premium barbershop in Almaty", portfolio_project1_link: "View site →",
    ...
    contact_telegram: "Write on Telegram", contact_whatsapp: "Write on WhatsApp",
